<%@ page language="java" import="com.syj.oamanager.entity.*" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
...
<%
	...
	if(!loginStaff.getAdmin().equals("admin")){
...
<body class="easyui-layout">
	<div region="north" style="height: 80px;background-color: #E0EDFF">
		...
		<div style="padding-top: 50px;padding-right: 20px;">当前用户：&nbsp;<font color="red" >${loginStaff.name }</font></div>
